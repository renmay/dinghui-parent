...
<style scoped>
  .list-left{width:301px;border:1px solid #E6E6E6;border-top: none;overflow: hidden;border-radius: 3px}
  .list-right{width:868px;border:1px solid #E6E6E6;border-top: none;overflow: hidden;border-radius: 3px}
  .new-item{padding:20px 10px;}
  .new-item li{width:100%;line-height: 30px;border-bottom: 1px dashed #ddd;}
  .new-item li i{display: inline-block;width:8px;height:8px;border-radius: 50%;}
  .new-item li span{font-size: 14px;}
  .hno{background-color:#fff;color:#333}
  .hno span{color:#333}
